package online.zhenhong.gdgfinder.search

import android.location.Location
import online.zhenhong.gdgfinder.network.GdgApiService
import online.zhenhong.gdgfinder.network.GdgChapter
import online.zhenhong.gdgfinder.network.GdgResponse
import online.zhenhong.gdgfinder.network.LatLong
...
class GdgChapterRepository(val gdgApiService: GdgApiService) {
     ...
     */
    private var request: Response<GdgResponse>? = null
     ...
     */
    private var inProgressSort: Response<SortedData>? = null
    ...
    private suspend fun sortedData(): SortedData = withContext(Dispatchers.Main) {
        ...
        // yet)
        inProgressSort?.body() ?: doSortData()
    }
...
//            inProgressSort = deferred
            ...
            request!!.body()?.let { SortedData.from(it, location) }
        }
        return result!!
    }
