...
import online.zhenhong.recyclersleeptracker.databinding.FragmentSleepTrackerBinding
...
class SleepTrackerFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val adapter = SleepNightAdapter(SleepNightAdapter.OnSleepNightClickListener { nightId ->
        ...
        sleepTrackerViewModel.navigateToSleepDataQuality.observe(
            viewLifecycleOwner,
            Observer { sleepNightKey ->
                sleepNightKey?.let {
                    this.findNavController().navigate(
                        SleepTrackerFragmentDirections
                            .actionSleepTrackerFragmentToSleepDetailFragment(sleepNightKey)
                    )
